...
void CAN_Hardware_Init(void)
{
    ...
    CAN_FilterInit(&(CAN_FilterInitTypeDef) {
        ...
        .CAN_FilterIdHigh = 0x200 << 5,                 // 过滤器 ID 高 16 位
        .CAN_FilterIdLow = 0x320 << 5,                  // 过滤器 ID 低 16 位
        .CAN_FilterMaskIdHigh = (0x700 << 5) | 0x10 | 0x8,             // 过滤器掩码高 16 位
        .CAN_FilterMaskIdLow = (0x7F0 << 5) | 0x10 | 0x8,              // 过滤器掩码低 16 位
